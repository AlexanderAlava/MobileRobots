...
def checkCamera():
    ...
    # Display the frame
        ...
        cv.imshow(WINDOW2, frame_with_keypoints_pink)
...
def mapping():
    ...
    while True:
        ...
        if distanceTravel > 18:
            ...
            if currentCell == 1 or currentCell == 2 or currentCell == 3 or currentCell == 4 or currentCell == 5 or currentCell == 8 or currentCell == 9 or currentCell == 12 or currentCell == 13 or currentCell == 14 or currentCell == 15 or currentCell == 16:
                turnToOuterWall()
...
def loadMap():
    global yellowCell, blueCell, pinkCell, greenCell, maze
    ...
    maze = [
    	...
    	Cell('W','O','W','O', False), Cell('W','O','W','O', False), Cell('W','O','O','W', False), Cell('O','O','W','W', False),
    	Cell('W','O','O','W', False), Cell('O','O','O','W', False), Cell('O','W','O','W', False), Cell('O','W','W','W', False)
    ]
...
def navigateToColor():
    colorInput = input("\nPress select a color option (Yellow, Blue, Green, Pink) to navigate to:\n\n(Y) Yellow.\n(B) Blue.\n(G) Green.\n(P) Pink.\n\n Enter any other key to exit the program.\n")
