...
def mapping():
    ...
    while True:
        ...
        if distanceTravel > 18:
            ...
            if currentCell == 1 or currentCell == 2 or currentCell == 3 or currentCell == 4 or currentCell == 5 or currentCell == 8 or currentCell == 9 or currentCell == 12 or currentCell == 13 or == 14 or currentCell == 15 or currentCell == 16:
                turnToOuterWall()
