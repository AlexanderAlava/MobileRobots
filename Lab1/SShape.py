...
def setSpeedsvw(v, w):
    ...
    circleVelocity1 = global wheelCircumference/ global circleTime
    velocityR_plus_velocityL = 2 * circleVelocity1
    velocityL_minus_velocityR = (global daxis * velocityR_plus_velocityL)/global circleRadius1
    velocityL = (circleVelocity1 / 2) + 0.15
    velocityR = (circleVelocity1 / 2) - 0.15
    omega = circleVelocity1/global circleRadius1
...
daxis = 3.95
circleVelocity1 = wheelCircumference/circleTime
velocityR_plus_velocityL = 2 * circleVelocity1
velocityL_minus_velocityR = (daxis * velocityR_plus_velocityL)/circleRadius1
velocityL = (circleVelocity1 / 2) + 0.15
velocityR = (circleVelocity1 / 2) - 0.15
omega = circleVelocity1/circleRadius1

while True:

    #setSpeedsIPS(float(xInches) / float(yTime), float(xInches) / float(yTime))
    setSpeedsIPS(6.0,4.0)
